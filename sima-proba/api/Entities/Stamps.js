...
var dao = require('sima-proba/data/dao/Entities/Stamps');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Stamps not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/sima-proba/api/Stamps.js/' + entity.ID);

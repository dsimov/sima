...
var dao = require('sima-proba/data/dao/Entities/Issuer');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Issuer not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/sima-proba/api/Issuer.js/' + entity.ID);

...
var dao = require('sima-proba/data/dao/Entities/DenominationUnits');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('DenominationUnits not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/sima-proba/api/DenominationUnits.js/' + entity.ID);

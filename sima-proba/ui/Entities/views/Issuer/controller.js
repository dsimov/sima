...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'sima-proba.Entities.Issuer.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('sima-proba.Entities.Issuer.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v3/js/sima-proba/api/Entities/Issuer.js';
